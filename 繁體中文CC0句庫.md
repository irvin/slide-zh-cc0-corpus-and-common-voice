...
- [Trad. Chinese & Taiwanese CC0 Corpus](https://github.com/moztw/cc0-sentences/)
- [Mozilla Common Voice](https://commonvoice.mozilla.org/)

Note:

逐家好，咱今仔日臺北暗時10點，欲開短短(tér-tér)的時間，來紹介開放語音資料庫 Common Voice，嘛順紲講台語語言資料的現況
我的腔口是臺北遮的同安腔，一寡詞慣勢唸近期(kūn-ki)、皮鞋(phê-uê)、鳥鼠(niáu-tshír)。
...
Contributor of OpenStreetMap Taiwan and Wikidata Taiwan, Chairperson of Wikimedia Taiwan

Note:

今仔日主要由我 Dennis 來紹介整個 Common Voice 計畫，Irvin 來補充佮實地 step-by-step 示範

---

![screenshot of common voice](https://i.imgur.com/rgtqFE5.jpg)
...
![languages that available in common voice](https://i.imgur.com/BBqXDei.png =600x)

![93 langauges](https://i.imgur.com/KJL2za1.png =200x)

Note:

Common Voice 這馬有 93種語言，有較濟人講的語言，嘛有較少人講的
...
Common Voice 整個計畫是想欲做出語言辨識技術，頭起先愛有句庫、愛有唸文句的聲音檔，才會當做出咱人會當用的語言辨識技術
...
Common Voice 是對 2017 年起頭的，欲相招逐家來參與錄音，建立各種語言的語音資料庫，濟濟的資料用 CC0 授權，白話講就是無任何版權的限制釋出，來促進(tshiok-tsìn)語言辨識、語言合成等等技術的開發佮研究

---

## 目前錄音成果 📈

![國語錄音時數107小時、驗證時數67小時；台語錄音時數6小時、驗證時數1小時](https://i.imgur.com/gTEDr2S.png)

Note:

這頁會當看著錄音的進度，華語總錄音時數107點鐘，驗證有67點鐘;台語有錄6點鐘，驗證1點鐘
...
雖然台語佮華語攏是臺灣日常咧講的語言，毋過你會當看著台語晚四年才開始的
...
台語的部份是 20,270 文句/字詞，其他的統計資料愛來想欲按怎算
...
這馬臺灣華語有 24,244 字詞，3,495 無仝的字，差不多是常用字的 83.8%
1,040 的發音
...
個人的文章、對話記錄、政治人物公務員的講稿抑是新聞稿;歌曲名、書名、地號名
...
來看目前的華語、台語語言資料庫的狀況，有中國的，有臺灣中研院的平衡語料庫，嘛有香港的
...
這是中研院平衡語料庫的申請的說明，限制非商業使用，限制學術研究使用，上重要是有價數
...
這就予咱想講，這馬臺灣開始五月納稅矣，為何用政府納稅的錢，建立的資料庫，有遮濟限制，甚至國人嘛無法度用
...
🎙 [聽／錄華語](http://commonvoice.mozilla.org/zh-tw)
...
- 國語對話紀錄（[sayit.pdis](https://sayit.pdis.nat.gov.tw/)、政府訪談稿、#rand0m 頻道⋯⋯）
    - 目前資料來源較單一，希望更多口語畫的句子
- 亟需**台語日常對話**句子（教材？）

Note:

歡迎有熟似教台語的先生(sian-sinn)的人，會當走傱問看覓，是毋是會當捐教材予 Common Voice 來用，予 Common Voice 有閣較口語的文句
...
整個 Common Voice 計畫需要有人做資料處理，語言學、統計資料，人工智慧。接接機關佮老師嘛真重要
...
嘛是有可能開別个臺灣語言的站，親像 Hakka fa，原住民族的濟濟語言。協助聯絡華語、台語老師敢會當捐教材資料
